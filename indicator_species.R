...
fish_table4 <- 
  separate(fish_table3, col = taxon, into = c("level", "taxon"), sep = "__")

fish_table4$level <- 
  ifelse(fish_table4$level == "g", "Genus", fish_table4$level)
fish_table4$level <- 
  ifelse(fish_table4$level == "f", "Family", fish_table4$level)
fish_table4$level <- 
  ifelse(fish_table4$level == "o", "Order", fish_table4$level)
fish_table4$level <- 
  ifelse(fish_table4$level == "c", "Class", fish_table4$level)
fish_table4$level <- 
  ifelse(fish_table4$level == "p", "Phylum", fish_table4$level)
fish_table4$level <- 
  ifelse(fish_table4$level == "d", "Domain", fish_table4$level)
